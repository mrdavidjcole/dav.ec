export default (req, res) => {
  ...
  const productManagerBullets = [
    ...
    "Worked with yet another amazing group of engineers and designers to create the <a href='https://wistia.com/support/developers/wistia-chooser'>Wistia Chooser component</a>, and the <a href='https://www.zendesk.com/apps/support/wistia/'>Wistia Zendesk integration</a>.",
  ];
